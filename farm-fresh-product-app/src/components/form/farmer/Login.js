...
>>>>>>> 3c3ed1ea53f19a677a7e0a2a2c950336acf71b2e
      ...
      <div className="container">
        ...
        <Link to="/customer-login">
          Not a farmer? Click here to login as a customer.
        </Link>
        {users.length > 0 && (
...
const FarmerLoginForm = withRouter(
  withFormik({
...
export default connect(mapStateToProps, mapDispatchToProps)(FarmerLoginForm);
